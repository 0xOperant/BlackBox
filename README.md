...
2. Once the setup is complete, you must scp your CA certificate (ca.crt) and public/private key pair (server.crt, server.key, generated offline) to the /etc/openvpn/ directory, and download the TLS key (ta.key) to your client.
